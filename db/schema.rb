...
ActiveRecord::Schema[8.1].define(version: 2026_02_02_232543) do
  ...
  create_table "settlement_files", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "file_type"
    ...
    t.index ["settlement_id"], name: "index_settlement_files_on_settlement_id"
  end
  ...
  add_foreign_key "settlement_files", "settlements"
end
